...
import { letterScreenHeading, letterScreenSubHeading, letterText } from "@/data"
        ...
        >
            <div className="max-w-4xl w-full">
                ...
                >
                    ...
                    {letterScreenSubHeading.trim().length !== 0 && <p className="text-lg text-purple-300">{letterScreenSubHeading}</p>}
                </motion.div>

                <motion.div
                    className="relative w-full h-full flex justify-center will-change-transform"
                ...
                >
                    <AnimatePresence mode="wait">
                        {!isOpen ? (
                            ...
                            <motion.div
                                key="letter"
                                className="w-full max-w-2xl rounded-2xl shadow-2xl border-2 border-pink-300 p-8 relative transition-all will-change-transform"
