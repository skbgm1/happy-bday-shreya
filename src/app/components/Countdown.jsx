...
import { Calendar, Clock, Sparkles, Gift, Cake } from "lucide-react"
...
export default function Countdown({ birthdayDate, onComplete }) {
    ...
    const timeUnits = [
        { label: "Days", value: timeLeft.days, color: "from-pink-500 to-rose-500", icon: Calendar },
        { label: "Hours", value: timeLeft.hours, color: "from-purple-500 to-pink-500", icon: Clock },
        { label: "Minutes", value: timeLeft.minutes, color: "from-indigo-500 to-purple-500", icon: Gift },
        { label: "Seconds", value: timeLeft.seconds, color: "from-blue-500 to-indigo-500", icon: Cake },
    ]
